...
const sections = [
  {
    ...
    content: `Welcome to 9jabillpoint we operates this Service. 
  ...
  },
  {
    title: "2. Definitions",
    content: [
      { term: "SERVICE", definition: "means the website or app operated by 9jabillpoint." },
  ...
  {
    title: "5. Use of Data",
    content: "9jabillpoint uses the collected data for various purposes, such as to provide and maintain our Service and to notify you about changes to it."
  },
  {
  ...
  },
  {
    ...
    content: `If you have any questions about this Privacy Policy, please contact us by email:
      ...
      support@9jabillpoint.co

      Phone: +2347 0140 69946`
  }
]
      ...
      <div className="container mx-auto py-8 px-4 sm:px-6 lg:px-8 mt-12">
        <Card className="w-full max-w-4xl mx-auto">
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground text-center mt-2">Last updated: 2025-01-30</p>
          </CardHeader>
          <CardContent>
...
function DefinitionItem({ term, definition }: { term: string; definition: string }) {
  return (
    <motion.div variants={itemVariants} className="mt-4">
      ...
      <dd className="ml-4 mt-1">{definition}</dd>
    </motion.div>
  )
}
